...
assert_log_contains "deploy-csi --namespace seaweedfs-csi --csi-image ghcr.io/appmana/seaweedfs-csi-driver:v1.4.12-appmana.post.4 --mount-image ghcr.io/appmana/seaweedfs-mount:v1.4.12-appmana.post.4 --filer 172.21.0.2:8888"
