...
CSI_IMAGE="${CSI_IMAGE:-ghcr.io/appmana/seaweedfs-csi-driver:v1.4.12-appmana.post.4}"
MOUNT_IMAGE="${MOUNT_IMAGE:-ghcr.io/appmana/seaweedfs-mount:v1.4.12-appmana.post.4}"
